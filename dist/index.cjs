...
function detectNvidiaGPU(hardware) {
  const smiOutput = (0, import_child_process.execSync)("nvidia-smi --query-gpu=memory.free --format=csv,noheader,nounits", { encoding: "utf-8" });
