...
import * as rewardsHelper from '../../../rewards.js';
...
describe('RewardsService', () => {
  ...
  it('calculateValidationScore() delegates to calculateValidationScore', () => {
    (rewardsHelper.calculateValidationScore as jest.Mock<any>).mockReturnValue(0.95);
  ...
  it('calculateWeight() delegates to calculateRewardWeight', () => {
    (rewardsHelper.calculateRewardWeight as jest.Mock<any>).mockReturnValue(0.05);
  ...
  it('calculateReward() delegates to calculateReward', () => {
    (rewardsHelper.calculateReward as jest.Mock<any>).mockReturnValue(47.5);
  ...
  it('normalize() delegates to normalizeRewards', () => {
    ...
    (rewardsHelper.normalizeRewards as jest.Mock<any>).mockReturnValue(normalized);
  ...
  it('calculateBatch() delegates to calculateRewardBatch', () => {
    (rewardsHelper.calculateRewardBatch as jest.Mock<any>).mockReturnValue(mockBatch);
  ...
  it('distribute() delegates to distributeRewards', async () => {
    ...
    (rewardsHelper.distributeRewards as jest.Mock<any>).mockResolvedValue(distResult);
  ...
  it('distribute() passes rpcUrl', async () => {
    (rewardsHelper.distributeRewards as jest.Mock<any>).mockResolvedValue({ success: true });
  ...
  it('getHistory() delegates to getRewardHistory', async () => {
    ...
    (rewardsHelper.getRewardHistory as jest.Mock<any>).mockResolvedValue(history);
  ...
  it('getHistory() passes limit and rpcUrl', async () => {
    (rewardsHelper.getRewardHistory as jest.Mock<any>).mockResolvedValue([]);
  ...
  it('getRecentBatches() delegates to getRecentBatches', async () => {
    (rewardsHelper.getRecentBatches as jest.Mock<any>).mockResolvedValue([mockBatch]);
  ...
  it('getRecentBatches() passes limit and rpcUrl', async () => {
    (rewardsHelper.getRecentBatches as jest.Mock<any>).mockResolvedValue([]);
